package Fridfiltrator.listenerPoller;
 ...
 * @author foo
 */
public class ListenerPoller implements Poller {
...
//	private Thread udp_listener;
    ...
    public ListenerPoller (InetAddress redirector_address, int redirector_port) {

            this.redirector_address = redirector_address;
            this.redirector_port = redirector_port;
            this.api = ApiWrapper.getInstance ().getApis ();
    }
...
//		udp_listener.interrupt ();
    ...
    @Override
    public boolean healthCheck (JTextArea logArea) {
        return false;
    }
